...
## Quick Test Script (Layman Version)
...
# Test 1: Casual stock comparison
...
1. **Uses everyday language** - "going up", "all over the place", "makes sense", "hot hand"
2. **Asks sophisticated questions** - correlation, mean reversion, earnings surprise correlation
3. **Triggers multiple tools** - still requires price history, earnings, comparative analysis
4. **Requires synthesis** - the agent must understand intent and orchestrate appropriately
5. **Sounds natural** - like someone at a bar asking their broker friend

The sophistication is **inherent in the question structure**, not the vocabulary. The agent still needs to:
...
But now it sounds like your neighbor asking, not a hedge fund analyst.