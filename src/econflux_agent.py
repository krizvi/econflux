...
def build_agent() -> Agent:
    ...
    - Cite your sources when drawing from knowledge bases with [Source: s3 source name]
    - Format any citations you receive in responses as proper footnotes 
    ...
    3. Knowledge bases (economic indicators, monetary policy, policy decisions, regulatory changes) producing chunks along with sources as citations
